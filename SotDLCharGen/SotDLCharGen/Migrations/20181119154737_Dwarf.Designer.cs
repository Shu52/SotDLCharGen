...
namespace SotDLCharGen.Migrations
{
    ...
    [Migration("20181119154737_Dwarf")]
    partial class Dwarf
    {
            ...
            modelBuilder.Entity("SotDLCharGen.Models.ApplicationUser", b =>
                {
                    ...
                    b.HasData(
                        new { Id = "ded24f9f-bcf5-4650-9880-f77c36194fab", AccessFailedCount = 0, ConcurrencyStamp = "972496e0-2b34-4832-8ff3-be019dc86a03", Email = "test@test.com", EmailConfirmed = true, LockoutEnabled = false, NormalizedEmail = "TEST@TEST.COM", PasswordHash = "AQAAAAEAACcQAAAAELzjQt+iZI7qwV2kgowJ7DNL1sxFbefWi+drFD8OC84DaG1SxA3OpSW6rEb6xHiQ3A==", PhoneNumberConfirmed = false, PlayerName = "test", SecurityStamp = "c83d82ce-2010-4645-8694-8435de2fb99d", TwoFactorEnabled = false, UserName = "test" }
                    );
                });
