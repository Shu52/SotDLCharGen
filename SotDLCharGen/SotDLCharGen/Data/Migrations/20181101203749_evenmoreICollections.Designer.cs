...
namespace SotDLCharGen.Data.Migrations
{
    ...
    [Migration("20181101203749_evenmoreICollections")]
    partial class evenmoreICollections
    {
            ...
            modelBuilder.Entity("SotDLCharGen.Models.ApplicationUser", b =>
                {
                    ...
                    b.HasData(
                        new { Id = "c6c4db43-c7a1-4aa9-9d8f-185b997e4b1c", AccessFailedCount = 0, ConcurrencyStamp = "10d58ff8-4539-420c-b2fc-dd5dcb5e02ef", Email = "test@test.com", EmailConfirmed = true, LockoutEnabled = false, NormalizedEmail = "TEST@TEST.COM", PasswordHash = "AQAAAAEAACcQAAAAEPbpdZ8C2TksLubJ4K+uJ5BPVonG5GtvMfqS9iB8Gkq0x4RMEXaMss9dK5A2kFVTOw==", PhoneNumberConfirmed = false, PlayerName = "test", SecurityStamp = "0c87b393-3810-409b-a0c4-1d5d307f708f", TwoFactorEnabled = false, UserName = "test" }
                    );
                });
